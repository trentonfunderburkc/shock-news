...
**Android-редirect:** только телефоны (`Android` + `Mobile`). iOS, desktop и планшеты остаются на shocknews.space. После смены env — **Redeploy**; статьи не пересобираются (см. `scripts/vercel-should-build.js`).
